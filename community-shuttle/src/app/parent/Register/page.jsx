...
export default function ParentAuth() {
  ...
  const switchTab = (tab) => {
    ...
    setStudentName("");
    setHomeAddress("");
    setSelectedRoute("Kinondoni Route");
    setMyChildStation("Makumbusho");
  };
    ...
    try {
      const { data: authData, error: authError } = await supabase.auth.signUp({
        ...
        options: {
          data: {
            ...
            route_group: selectedRoute,
            pickup_station: myChildStation,
      ...
      if (profileError) {
        if (profileError.code === "23505") {
          setSuccessMsg("Account already registered. Please login.");
        } else {
        ...
        <div className="hidden lg:flex flex-col justify-between w-[360px] shrink-0 bg-gradient-to-b from-cyan-600 to-cyan-800 p-8">
          <div>
            ...
            <h1 className="text-3xl font-black text-white leading-tight tracking-tight">
              Your Child's
              <br />
              <span className="text-cyan-200">Safe Journey</span>
              <br />
              Starts Here
            </h1>
              ...
              {[
                ...
                <button
                  ...
                  className={`flex-1 py-2.5 rounded-xl text-xs font-black transition-all ${
                    activeTab === tab.id ? "bg-cyan-600 text-white shadow-md" : "text-slate-400 hover:text-slate-700"
                  }`}
                >
                  {tab.label}
                </button>
              ...
              <form onSubmit={handleLogin} className="space-y-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-4 py-3.5 pr-12 border-2 border-slate-200 rounded-xl text-sm focus:outline-none focus:border-cyan-500 bg-slate-50 focus:bg-white transition"
                    />
                    <button
                      type="button"
                      tabIndex={-1}
                ...
                <p className="text-center text-xs text-slate-400">
                  ...
                  <button
                    ...
                    className="text-cyan-600 hover:text-cyan-500 font-bold transition"
                  >
                    Register here
                  </button>
                </p>
              ...
              <form onSubmit={handleRegister} className="space-y-3.5">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input
                      type="text"
                      required
                      placeholder="e.g. Frank Mapunda"
                      value={parentName}
                      onChange={(e) => setParentName(e.target.value)}
                      className="w-full px-3 py-3 border-2 border-slate-200 rounded-xl text-sm focus:outline-none focus:border-cyan-500 bg-slate-50 focus:bg-white transition"
                    />
                  </div>
                  <div>
                    <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1.5">
                ...
                <div>
                  ...
                  <input
                    ...
                    value={email}
                    onChange={(e) => setEmail(e.target.value)}
                    className="w-full px-4 py-3 border-2 border-slate-200 rounded-xl text-sm focus:outline-none focus:border-cyan-500 bg-slate-50 focus:bg-white transition"
                  />
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3 py-3 border-2 border-slate-200 rounded-xl text-sm focus:outline-none focus:border-cyan-500 bg-slate-50 transition"
                    >
                ...
                <div>
                  ...
                  <input
                    type="text"
                    required
                    placeholder="e.g. House No. 45, Upanga East"
                    value={homeAddress}
                    ...
                    {Object.keys(ROUTE_STATIONS).map((route) => (
                      <button
                        ...
                        onClick={() => {
                          ...
                          setMyChildStation(ROUTE_STATIONS[route][0]);
                        }}
                  ...
                  <div className="space-y-1.5">
                    {ROUTE_STATIONS[selectedRoute]?.map((station) => (
                      <button
                        key={station}
                        type="button"
                        onClick={() => setMyChildStation(station)}
                      ...
                      >
                        <span
                          className={`w-2 h-2 rounded-full shrink-0 ${
                            myChildStation === station ? "bg-cyan-500" : "bg-slate-300"
                          }`}
                        />
                        📍 {station}
                      </button>
